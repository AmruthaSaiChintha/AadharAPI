...
namespace AadhaarVerification.Controllers
{
    ...
    public class UserDataController : ControllerBase
    {
        ...
        {
            var userWithEmail = await _context.Datas.FirstOrDefaultAsync(x => x.Email == email);

            if (userWithEmail != null)
            {
                // Email exists, return a success response
                return Ok(new { message = "Email is valid" });
            }

            // Email does not exist, return a not found response
